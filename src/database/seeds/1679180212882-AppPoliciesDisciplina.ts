...
export class AppPoliciesDisciplina1679180212882 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP POLICY "Everyone can read disciplina" ON disciplina;');

    await queryRunner.query('DROP POLICY "Authed user with cargo \'dape\' can manage disciplina" ON disciplina;');
  }
}
