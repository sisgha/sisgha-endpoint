...
import { APP_RESOURCE_CARGO, APP_RESOURCE_USUARIO_CARGO } from 'src/actor-context/providers';
import { ContextAction } from 'src/authorization/interfaces';
import { UsuarioCargoDbEntity } from 'src/database/entities/usuario_cargo.db.entity';
...
import { IFindUsuarioCargoByIdInput } from './dtos/FindUsuarioCargoByIdInput';
